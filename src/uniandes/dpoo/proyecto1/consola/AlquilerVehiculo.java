...
public class AlquilerVehiculo implements Tarifable{
	 ...
	 * precond: El alquiler debe estar inicializado.
	 * 			Los datos necesarios para calcular el costo adicional del 70% por temporada alta deben estar disponibles y correctos en el sistema, incluyendo la información del alquiler y las fechas de inicio y fin.
	 * 			El sistema debe tener acceso a la clase Tarifa para realizar el cálculo.
	 * 			Las fechas de inicio y fin del alquiler deben ser válidas y estar disponibles.
