            ...
            while (linea != null) {
                ...
                if (usuario.equals(cuenta) && contra.equals(password)) {
                    if (jerarquia.equals("AG")) {
                        ...
                        usuarioreal = new AdministradorLocal(usuario, contra, jerarquia, info[3], info[4], info[5], info[6], info[7], info[13]);                        usuarioreal.getRol();
                    } 
	...
	public static void main(String[] args) throws Exception {
		...
		*inventariogeneral.mostrarinventariototal();*/
		...
		while (revision_opciones == true){
			...
			if (opcion == 15) {
				inventariogeneral.mostrarinventarioalquilado();
